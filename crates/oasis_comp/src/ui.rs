                    ...
                    let updates: Vec<(ParamPtr, f32)> = {
                        ...
                        preset.values.iter().filter_map(|&(param_id, norm_val)| {
                            let ptr = match param_id {
                                "threshold" => Some(params.threshold.as_ptr()),
                                "ratio" => Some(params.ratio.as_ptr()),
                                "attack" => Some(params.attack_ms.as_ptr()),
                                "release" => Some(params.release_ms.as_ptr()),
                                "knee" => Some(params.knee_db.as_ptr()),
                                "makeup" => Some(params.makeup_db.as_ptr()),
                                "mix" => Some(params.mix.as_ptr()),
                                "detection" => Some(params.detection_mode.as_ptr()),
                                "sc_hp_freq" => Some(params.sc_hp_freq.as_ptr()),
...
pub fn create_editor(params: Arc<OasisCompParams>) -> Option<Box<dyn Editor>> {
    ...
    create_vizia_editor(editor_state, ViziaTheming::Custom, move |cx, _| {
        ...
        VStack::new(cx, |cx| {
            ...
            HStack::new(cx, |cx| {
                VStack::new(cx, |cx| {
                    VStack::new(cx, |cx| {
                        Label::new(cx, "DYNAMICS").class("section-title");
                        HStack::new(cx, |cx| {
                            knob_control(cx, "Threshold", Data::params, |p| &p.threshold, false);
                            knob_control(cx, "Ratio", Data::params, |p| &p.ratio, false);
                            knob_control(cx, "Attack", Data::params, |p| &p.attack_ms, false);
                        })
                        .class("knob-row");
                        HStack::new(cx, |cx| {
                            knob_control(cx, "Release", Data::params, |p| &p.release_ms, false);
                            knob_control(cx, "Knee", Data::params, |p| &p.knee_db, false);
                        })
                        .class("knob-row");
                    })
                    .class("section");
                ...
                VStack::new(cx, |cx| {
                    VStack::new(cx, |cx| {
                        Label::new(cx, "CHARACTER").class("section-title");
                        toggle_control(cx, "Detection", Data::params, |p| &p.detection_mode);
                    })
                    .class("section");
                    ...
                    VStack::new(cx, |cx| {
                        ...
                        HStack::new(cx, |cx| {
                            knob_control(cx, "Makeup", Data::params, |p| &p.makeup_db, false);
                            knob_control(cx, "Mix", Data::params, |p| &p.mix, false);
                        })
                        .class("knob-row");
                        HStack::new(cx, |cx| {
                            knob_control(cx, "Gain", Data::params, |p| &p.output_gain, true);
                            knob_control(cx, "SC HP", Data::params, |p| &p.sc_hp_freq, false);
                        })
                        .class("knob-row");
                    })
                    .class("section");
