                        ...
                        preset
                            ...
                            .filter_map(|&(param_id, norm_val)| {
                                let ptr = match param_id {
                                    "osc1_wave" => Some(params.osc1_waveform.as_ptr()),
                                    "osc1_level" => Some(params.osc1_level.as_ptr()),
                                    "osc1_detune" => Some(params.osc1_detune.as_ptr()),
                                    "osc2_wave" => Some(params.osc2_waveform.as_ptr()),
                                    "osc2_level" => Some(params.osc2_level.as_ptr()),
                                    "osc2_detune" => Some(params.osc2_detune.as_ptr()),
                                    "filter_cutoff" => Some(params.filter_cutoff.as_ptr()),
                                    "filter_reso" => Some(params.filter_resonance.as_ptr()),
                                    "env_attack" => Some(params.env_attack.as_ptr()),
                                    "env_decay" => Some(params.env_decay.as_ptr()),
                                    "env_sustain" => Some(params.env_sustain.as_ptr()),
                                    "env_release" => Some(params.env_release.as_ptr()),
                                    "master_gain" => Some(params.master_gain.as_ptr()),
                                    _ => None,
                                };
...
pub fn create_editor(params: Arc<OasisSynthParams>) -> Option<Box<dyn Editor>> {
            ...
            HStack::new(cx, |cx| {
                ...
                VStack::new(cx, |cx| {
                    VStack::new(cx, |cx| {
                        ...
                        toggle_control(cx, "Wave", Data::params, |p| &p.osc1_waveform);
                        HStack::new(cx, |cx| {
                            knob_control(cx, "Level", Data::params, |p| &p.osc1_level, false);
                            knob_control(cx, "Detune", Data::params, |p| &p.osc1_detune, false);
                        })
                        .class("knob-row");
                    })
                    .class("section");
                    ...
                    VStack::new(cx, |cx| {
                        ...
                        toggle_control(cx, "Wave", Data::params, |p| &p.osc2_waveform);
                        HStack::new(cx, |cx| {
                            knob_control(cx, "Level", Data::params, |p| &p.osc2_level, false);
                            knob_control(cx, "Detune", Data::params, |p| &p.osc2_detune, false);
                        })
                        .class("knob-row");
                    })
                    .class("section");
                ...
                // Right column: Filter, Envelope, Master
                VStack::new(cx, |cx| {
                    VStack::new(cx, |cx| {
                    ...
                    VStack::new(cx, |cx| {
                        ...
                        HStack::new(cx, |cx| {
                            knob_control(cx, "Attack", Data::params, |p| &p.env_attack, false);
                            knob_control(cx, "Decay", Data::params, |p| &p.env_decay, false);
                            knob_control(
                                cx,
                                "Sustain",
                                Data::params,
                    ...
                    VStack::new(cx, |cx| {
                        Label::new(cx, "MASTER").class("section-title");
                        HStack::new(cx, |cx| {
                            knob_control(
                                cx,
                                "Gain",
